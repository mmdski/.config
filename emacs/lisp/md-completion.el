...
(use-package
 ...
 :ensure t
 :bind
 (("C-s" . consult-line) :map minibuffer-local-map ("C-r" . consult-history))
 :init
...
(use-package
 embark
 :bind (("<remap> <describe-bindings>" . embark-bindings) ("C-." . embark-act))
...
(use-package
 ...
 :custom (corfu-cycle t) (corfu-auto t) (corfu-auto-prefix 2)

 :config
 ;; Popup info is an extension included with Corfu (not a separate package)
 (corfu-popupinfo-mode 1) (eldoc-add-command #'corfu-insert)
